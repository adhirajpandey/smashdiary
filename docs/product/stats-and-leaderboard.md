...
It is generated by `getLeaderboard(matches, players, format)` and returns only the top `3` rows for the active format.
...
- leaderboard top three for the active format
