...
All dashboard and stats metrics are derived from this filtered set first.
...
The dashboard's activity section is format-specific.
...
The leaderboard is shared across dashboard and stats, and it is format-specific.
